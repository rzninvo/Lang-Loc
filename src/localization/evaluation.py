...
from src.localization.prediction import (
...
from src.localization.coarse_search import (
...
def _show_3d_scene(scene_id, scene_dir, mesh, obj2faces, obj_ids,
    ...
    from src.localization.visualization import GUI_INITIALISED
    import src.localization.visualization as viz_mod

    matched_set = {int(o) for o in obj_ids}
    frustum_scale = max(grid_step * 3.0, 0.6)

    try:
        from src.visualization.visualize_3rscan_segments import build_segmented_mesh
