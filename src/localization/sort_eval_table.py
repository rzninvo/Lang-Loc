...
Usage::
    ...
    python -m src.localization.sort_eval_table eval_loc_summary.log
    python -m src.localization.sort_eval_table eval_loc_summary.log --sort "Err (m)" --desc --top 50
    python -m src.localization.sort_eval_table eval_loc_summary.log --sort "R90%" --asc
"""
