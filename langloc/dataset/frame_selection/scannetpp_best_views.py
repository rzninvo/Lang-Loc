...
def main(scene_id: str, cfg: DictConfig, device_str: str | None = None,
         debug: bool = False, viz_first: int = 3, viz_selected: int = 0,
         auto_clean: bool = False, save_semantic_masks: bool = False,
         save_instance_masks: bool = False) -> None:
    """
    ...
    """
    nbv_cfg = extract_nbv_config(cfg.dataset, dataset="scannetpp")

    # Paths
    dataset_path = Path(cfg.paths.scannet_root)
